        ...
        <el-form :model="groupForm" label-width="50px">
            ...
            <template v-if="!groupForm.hasChild">
                <el-form-item label="Video">
                    <el-input
                        placeholder="Input video url,split with ','"
                        v-model="groupForm.groupMediaUrl"
                        type="textarea"
                    ></el-input>
                </el-form-item>
                <el-form-item label="Audio">
                    <el-input
                        placeholder="Input audio url,split with ','"
                        v-model="groupForm.groupAudioUrl"
                        type="textarea"
                    ></el-input>
                </el-form-item>
                <el-form-item label="Article">
                    <el-input
                        placeholder="Input article url,split with ','"
                        v-model="groupForm.groupArticleUrl"
                        type="textarea"
                    ></el-input>
                </el-form-item>
